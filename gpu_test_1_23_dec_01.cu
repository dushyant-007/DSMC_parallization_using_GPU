...
{
    //A = new int[a] ;
    cudaMallocManaged(&A, sizeof(int)*a) ;
    cudaMemset(A, 0, a*sizeof(int)) ;
}
                        ...
                        if(III==0)
                        {
                            ...
                            if(MSP==1)
                            {
                                ...
                                if(RANF<CVR/CCELL[4][N])
                                {
                                    ...
                                    //TOTCOL=TOTCOL+1.e00;
                                    COLL_TOTCOL[N]=COLL_TOTCOL[N]+1.e00;    //problem
                                    TCOL[1][1]=TCOL[1][1]+2.e00;    //problem
